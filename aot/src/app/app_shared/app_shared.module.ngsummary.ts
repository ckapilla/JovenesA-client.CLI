...
export function AppSharedModuleNgSummary():any[] {
  return [{summaryKind:2,type:{reference:i0.AppSharedModule,diDeps:([] as any[]),lifecycleHooks:([] as any[])},
      entryComponents:([] as any[]),providers:[{provider:{token:{identifier:{reference:i1.NgLocalization}},
          ...
          {provider:{token:{identifier:{reference:i3.FormBuilder,diDeps:([] as any[]),
              ...
              lifecycleHooks:([] as any[])}},{provider:{token:{identifier:{reference:i3.ɵi,
              diDeps:([] as any[]),lifecycleHooks:([] as any[])}},useClass:{reference:i3.ɵi,
              diDeps:([] as any[]),lifecycleHooks:([] as any[])},useValue:(undefined as any),
              useFactory:(null as any),useExisting:(undefined as any),deps:([] as any[]),
              multi:false},module:{reference:i3.FormsModule,diDeps:([] as any[]),lifecycleHooks:([] as any[])}}],
      modules:[{reference:i1.CommonModule,diDeps:([] as any[]),lifecycleHooks:([] as any[])},
          ...
          {reference:i3.ɵbc,diDeps:([] as any[]),lifecycleHooks:([] as any[])},{reference:i3.ReactiveFormsModule,
              diDeps:([] as any[]),lifecycleHooks:([] as any[])},{reference:i3.FormsModule,
              diDeps:([] as any[]),lifecycleHooks:([] as any[])},{reference:i0.AppSharedModule,
              diDeps:([] as any[]),lifecycleHooks:([] as any[])}],exportedDirectives:[{reference:i1.NgClass},
...
//# sourceMappingURL=data:application/json;base64,
