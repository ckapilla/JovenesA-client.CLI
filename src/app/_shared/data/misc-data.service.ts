...
export class MiscDataService extends BaseDataService {
  ...
  mentors$: Observable<SELECTITEM[]> = this.http
    .get<SELECTITEM[]>(this.mentorsUrl)
    .pipe(
  ...
  sponsorGroups$: Observable<SELECTITEM[]> = this.http
    .get<SELECTITEM[]>(this.sponsorGroupsUrl)
    .pipe(
  ...
  universities$: Observable<SELECTITEM[]> = this.http
    .get<SELECTITEM[]>(this.universitiesUrl)
    .pipe(
  ...
  universityGradeMonths$: Observable<SELECTITEM[]> = this.http
    .get<SELECTITEM[]>(this.universityGradeMonthsUrl)
    .pipe(
  ...
  prepas$: Observable<SELECTITEM[]> = this.http
    .get<SELECTITEM[]>(this.prepasUrl)
    .pipe(
