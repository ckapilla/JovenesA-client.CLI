...
export class MemberDataService extends BaseDataService {
  ...
  public getMemberWithAnyRelatedStudent(
    type: string,
    status: number,
    studentStatus: number
  ): Observable<MemberWithAnyRelatedStudent[]> {
    const url = this.WebApiPrefix + 'members/related_students/' + type + '/' + status + '/' + studentStatus;
    // statusId: vm.selectedStatus.statusId, gradYear: vm.selectedGradYear.year, yearJoinedJA: vm.selectedYearJoined.year },
