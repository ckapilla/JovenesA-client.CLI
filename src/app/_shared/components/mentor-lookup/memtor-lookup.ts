...
export class MentorNameService {
  ...
  search(searchStr: string) {
    ...
    return this.memberData.getCurrentMemberMiniDTOs(searchStr)
      .pipe(
...
@Component({
  selector: 'app-mentor-lookup',
  templateUrl: './mentor-lookup.html'
})
export class MentorLookupComponent implements OnInit, OnDestroy {
  ...
  constructor(private _service: MentorNameService,
