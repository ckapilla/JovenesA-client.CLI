...
export class ConfidentialReportsAddComponent implements OnInit {
  myForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.confidentialReport.lastContactYear = constants.currentContactYear;
  ...
  onSubmit(): void {
    ...
    this.confidentialReportData.addConfidentialReport(this.confidentialReport).subscribe(
      (student) => {
